            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="buku" name="produk" id="buku" type="radio" class="custom-control-input" required>
                        <label for="buku" class="custom-control-label">Buku</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="pulpen" name="produk" id="pulpen" type="radio" class="custom-control-input" required>
                        <label for="pulpen" class="custom-control-label">Pulpen</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="pensil" name="produk" id="pensil" type="radio" class="custom-control-input" required>
                        <label for="pensil" class="custom-control-label">Pensil</label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
